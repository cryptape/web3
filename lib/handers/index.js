    ...
    apply: function (target, thisArg, argumentsList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tx.quota) {
                ...
                return exports.request(thisArg.currentProvider.host, exports.rpcParams("cita_sendTransaction", [unverifiedTransactionData.slice(2)]));
            }
...
exports.getBlockHandler = {
    apply: function (target, thisArg, argumentsList) {
        ...
        if (hashOrNumber.length === 66) {
            return exports.request(thisArg.currentProvider.host, exports.rpcParams("cita_getBlockByHash", [hashOrNumber, argumentsList[1] || false]));
        }
        return exports.request(thisArg.currentProvider.host, exports.rpcParams("cita_getBlockByNumber", [hashOrNumber, argumentsList[1] || false]));
    }
};
